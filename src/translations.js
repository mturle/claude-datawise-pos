const T = {
  pl: {
    ...
    popup: {
      ...
      sectionDemographics: "Demografia i potencjał",
      sectionSurroundings: "Otoczenie — POI i konkurencja",
      sectionTraffic: "Ruch (T-Mobile, 1000 m)",
      sectionCards: "Wydatki (Visa)",
      sectionLifestyle: "Profil konsumenta (udział aktywnych kart Visa)",
      fields: {
        category: "Kategoria",
        ...
        dochSum: "Dochód rozporządzalny (suma - 1 km)",
        dochAvg: "Dochód rozporządzalny (średnia)",
        ...
        cardsUniq: "Unikalne karty",
        totalTrn: "Transakcje łącznie",
        onlineTrn: "Transakcje online",
  ...
  en: {
    ...
    popup: {
      ...
      sectionDemographics: "Demographics & potential",
      sectionSurroundings: "Surroundings — POI & competition",
      sectionTraffic: "Traffic (T-Mobile, 1000 m)",
      sectionCards: "Spendings (Visa)",
      sectionLifestyle: "Consumer profile (share of active Visa cards)",
      fields: {
        category: "Category",
        ...
        dochSum: "Disposable income (total - 1 km)",
        dochAvg: "Disposable income (average)",
        ...
        cardsUniq: "Unique cards",
        totalTrn: "Total transactions",
        onlineTrn: "Online transactions",
